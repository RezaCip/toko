...
<body id="page-top">
  ...
  <script src="{{asset('aset/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('aset/js/demo/chart-pie-demo.js')}}"></script>
...
<script src="{{asset('aset/js/autoComplete.js')}}"></script>
  @yield('js')
